...
export function AgentTrackToggle({
  ...
  className,
  onPressedChange,
  // Base UI's Toggle types `value` as string; drop the native button value.
  ...
  return (
    <Toggle
      ...
      {...props}
    >
      {/* eslint-disable-next-line react-hooks/static-components -- getSourceIcon selects an existing icon component; nothing is defined during render */}
